...
/******/ 	var hotCurrentHash = "7986a45096fec94ee367"; // eslint-disable-line no-unused-vars
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_zen_observable__ = __webpack_require__("../../node_modules/zen-observable/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_zen_observable__ = __webpack_require__("../../node_modules/zen-observable/index.js");
...
var fs_1 = __webpack_require__("fs");
var graphql_tools_1 = __webpack_require__("graphql-tools");
...
function startAuthenticationServer() {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        var server, html, configureGraphql, _a, resolvers, schemas, endpoint, link, graphcoolSchema, _b, _c, requestHandler;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    configureGraphql = __webpack_require__("./src/server/graphqlConfig.ts").configureGraphql;
                    return [4 /*yield*/, configureGraphql()];
                case 1:
                    _a = _d.sent(), resolvers = _a.resolvers, schemas = _a.schemas;
                    endpoint = 'http://localhost:60000/simple/v1/cjapptdzb00040160sf97d2jg';
                    link = new apollo_link_http_1.HttpLink({ uri: endpoint, fetch: fetch });
                    _b = graphql_tools_1.makeRemoteExecutableSchema;
                    _c = {};
                    return [4 /*yield*/, graphql_tools_1.introspectSchema(link)];
                case 2:
                    graphcoolSchema = _b.apply(void 0, [(_c.schema = _d.sent(),
                            _c.link = link,
                            _c)]);
                    ...
                    if (module.hot != undefined) {
                        module.hot.accept("./src/server/graphqlConfig.ts", function () { return __awaiter(_this, void 0, void 0, function () {
                            var newConfigureGraphql, _a, newResolvers, newSchemas;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        newConfigureGraphql = __webpack_require__("./src/server/graphqlConfig.ts").configureGraphql;
...
module.exports = __webpack_require__("./src/server/startServer.hot.ts");
