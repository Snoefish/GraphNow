 ...
 */
function generateJWT(secretKey, authenticate, username, password) {
    return __awaiter(this, void 0, void 0, function () {
        var profile, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, authenticate(username, password)];
                case 1:
                    profile = _a.sent();
                    token = jwt.sign(profile, secretKey, { expiresIn: '24h' });
